...
class ResourceEntry:
    ...
    content: Optional[str] = None  # For inline resources (formula, code)
    file_path: Optional[str] = None  # For binary resources (images)
